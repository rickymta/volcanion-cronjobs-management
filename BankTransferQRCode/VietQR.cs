...
public class VietQR
{
    private string payloadFormatIndicator = "000201";
    private string pointOfInitiationMethod = "010212";
    private string consumerAccountInformation = "";
    private string guid = "0010A000000727";
    private string serviceCode = "0208QRIBFTTA";
    private string transactionCurrency = "5303704";
    private string transactionAmount = "";
    private string countryCode = "5802VN";
    private string additionalDataFieldTemplate = "";
    private string crc = "";

    public VietQR SetTransactionAmount(string money)
    {
    ...
    public VietQR SetBeneficiaryOrganization(string acquierID, string consumerID)
    {
        ...
        string beneficiaryOrganizationLength = ConvertLength($"{acquier}{consumer}".Length);

        string consumerAccountInformationLength = ConvertLength(int.Parse(beneficiaryOrganizationLength) + 30);
        consumerAccountInformation = $"38{consumerAccountInformationLength}{guid}01{beneficiaryOrganizationLength}{acquier}{consumer}0208QRIBFTTA";
        return this;
    }
    ...
    public VietQR SetAdditionalDataFieldTemplate(string content)
    {
        ...
        string additionalDataFieldTemplateLength = ConvertLength(content.Length + 4);
    ...
    public string Build()
    {
        ...
        ushort crcValue = CalcCRC(contentQR);
        string crcHex = crcValue.ToString("X4");
